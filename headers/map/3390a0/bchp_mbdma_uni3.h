 ...
 *
 *
 * Date:           Generated on              Fri Nov 21 03:17:40 2014
 ...
 ***************************************************************************/
#define BCHP_MBDMA_UNI3_STATUS                   0x00400000 /* MBDMA Interrupt Status */
#define BCHP_MBDMA_UNI3_TOKENCACHECTL            0x00400004 /* Token Free Cache Control */
#define BCHP_MBDMA_UNI3_TOKENADDRESSFREE         0x00400008 /* Free Pool Manager Token free address */
#define BCHP_MBDMA_UNI3_GLOBALCTL                0x0040000c /* LAN MsgID, arbitration control and token cache flush */
#define BCHP_MBDMA_UNI3_BUFFERBASE0              0x00400010 /* Free pool buffer base address */
#define BCHP_MBDMA_UNI3_UPPER_UBUS_ADDRESS       0x00400014 /* Ubus address bits 39:32 */
#define BCHP_MBDMA_UNI3_CHANERR                  0x00400018 /* Channel error indicators, one bit per channel */
#define BCHP_MBDMA_UNI3_CHANERRMASK              0x0040001c /* Interrupt mask for channel error */
#define BCHP_MBDMA_UNI3_BACKPRESSCTL0            0x00400020 /* Token allocation low and not low thresholds 2k and 1k tokens */
#define BCHP_MBDMA_UNI3_BACKPRESSCTL1            0x00400024 /* Token allocation low and not low thresholds 512 and 256 tokens */
#define BCHP_MBDMA_UNI3_DIAGOUT                  0x00400028 /* Current diag output value */
#define BCHP_MBDMA_UNI3_DIAGCOMPARE              0x0040002c /* Compare value for Diag interrupt */
#define BCHP_MBDMA_UNI3_DIAGMASK                 0x00400030 /* Diag compare mask for Diag interrupt */
#define BCHP_MBDMA_UNI3_CAPTURESTATUS            0x00400034 /* Capture status flags for ubus capture trigger */
#define BCHP_MBDMA_UNI3_CAPTUREMASK              0x00400038 /* Capture mask for ubus capture trigger */
#define BCHP_MBDMA_UNI3_STATUS2                  0x0040003c /* Reserved - Combined Interrupt Status */
#define BCHP_MBDMA_UNI3_INTRMASK                 0x00400040 /* Interrupt mask, ANDed with STATUS */
#define BCHP_MBDMA_UNI3_TOKENCACHECTL2           0x00400044 /* Token Allocation Cache Burst Control */
#define BCHP_MBDMA_UNI3_TOKENCACHECTL3           0x00400048 /* Token Allocation Cache Enables */
#define BCHP_MBDMA_UNI3_TOKENADDRESS256          0x0040004c /* Free Pool Manager token allocation address for 256B tokens */
#define BCHP_MBDMA_UNI3_TOKENADDRESS512          0x00400050 /* Free Pool Manager token allocation address for 512B tokens */
#define BCHP_MBDMA_UNI3_TOKENADDRESS1K           0x00400054 /* Free Pool Manager token allocation address for 1kB tokens */
#define BCHP_MBDMA_UNI3_TOKENADDRESS2K           0x00400058 /* Free Pool Manager token allocation address for 2kB tokens */
#define BCHP_MBDMA_UNI3_TOKENBOUNDS              0x0040005c /* Token Cache memory bounds */
#define BCHP_MBDMA_UNI3_TOKENSTATUS              0x00400060 /* Token allocation levels */
#define BCHP_MBDMA_UNI3_TOKENSTATUS2             0x00400064 /* Token free level */
#define BCHP_MBDMA_UNI3_SCBCONTROL               0x00400068 /* SCB port status */
#define BCHP_MBDMA_UNI3_SCBSTATUS                0x0040006c /* SCB port control */
#define BCHP_MBDMA_UNI3_SCBADDRESSLO_0           0x00400070 /* SCB token base address LSBs */
#define BCHP_MBDMA_UNI3_SCBADDRESSHI_0           0x00400074 /* SCB token base address MSBs */
#define BCHP_MBDMA_UNI3_MDIOIRQSTAT              0x00400078 /* MDIO controller interrupt status */
#define BCHP_MBDMA_UNI3_MDIOIRQENABLE            0x00400080 /* MDIO controller interrupt enables */
#define BCHP_MBDMA_UNI3_BUFFERBASE1              0x00400084 /* Free pool buffer base address, second pool */
#define BCHP_MBDMA_UNI3_SCBADDRESSLO_1           0x00400088 /* SCB token base address LSBs, second pool */
#define BCHP_MBDMA_UNI3_SCBADDRESSHI_1           0x0040008c /* SCB token base address MSBs, second pool */
#define BCHP_MBDMA_UNI3_CHANCONTROL00            0x00400100 /* Channel 0 Rx control */
#define BCHP_MBDMA_UNI3_LANMSGADDRESS00          0x00400104 /* Target for LAN RX message for channel 0 */
#define BCHP_MBDMA_UNI3_RXOFFSET00               0x00400108 /* Rx buffer offset for channel 0 */
#define BCHP_MBDMA_UNI3_RXSTATUS00               0x0040010c /* Error status for channel 0 */
#define BCHP_MBDMA_UNI3_CHANCONTROL01            0x00400120 /* Channel 1 Tx control */
#define BCHP_MBDMA_UNI3_LANMSGADDRESS01          0x00400124 /* Target address for TX STATUS message for channel 1 */
#define BCHP_MBDMA_UNI3_CHANCONTROL01_2          0x00400128 /* Channel 1 Tx control register 2 */
#define BCHP_MBDMA_UNI3_CHANCONTROL02            0x00400140 /* Channel 2 Tx control */
#define BCHP_MBDMA_UNI3_LANMSGADDRESS02          0x00400144 /* Target address for TX STATUS message for channel 2 */
#define BCHP_MBDMA_UNI3_CHANCONTROL02_2          0x00400148 /* Channel 2 Tx control register 2 */
#define BCHP_MBDMA_UNI3_LANTXMSGFIFO01           0x00400500 /* LAN TX message FIFO for channel 01, Unimac0 low priority */
#define BCHP_MBDMA_UNI3_LANTXMSGFIFO02           0x00400508 /* LAN TX message FIFO for channel 02, Unimac0 high priority */
 ...
 ***************************************************************************/
/* MBDMA_UNI3 :: MDIOIRQENABLE :: reserved0 [31:03] */
#define BCHP_MBDMA_UNI3_MDIOIRQENABLE_reserved0_MASK               0xfffffff8
#define BCHP_MBDMA_UNI3_MDIOIRQENABLE_reserved0_SHIFT              3

 ...
 ***************************************************************************/
#define BCHP_MOCA_HOSTMISC_MISC_CTRL             0x213ffd00 /* [RW] Moca Software Reset */
#define BCHP_MOCA_HOSTMISC_SCRATCH               0x213ffd04 /* [RW] Moca Scratch Register */
#define BCHP_MOCA_HOSTMISC_VERSION               0x213ffd08 /* [RO] MoCA version register */
#define BCHP_MOCA_HOSTMISC_H2M_INT_TRIG          0x213ffd0c /* [WO] Host-to-MoCA Interrupt Trigger */
#define BCHP_MOCA_HOSTMISC_WAKEUP                0x213ffd10 /* [WO] Host-to-MoCA Wakeup Interrupt */
#define BCHP_MOCA_HOSTMISC_SUBSYS_CFG            0x213ffd14 /* [RW] Moca Subsystem configuration */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_0      0x213ffd18 /* [RW] Host to MoCA MMP outbox registes , register set index 0. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_1      0x213ffd1c /* [RW] Host to MoCA MMP outbox registes , register set index 1. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_2      0x213ffd20 /* [RW] Host to MoCA MMP outbox registes , register set index 2. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_3      0x213ffd24 /* [RW] Host to MoCA MMP outbox registes , register set index 3. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_4      0x213ffd28 /* [RW] Host to MoCA MMP outbox registes , register set index 4. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_5      0x213ffd2c /* [RW] Host to MoCA MMP outbox registes , register set index 5. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_6      0x213ffd30 /* [RW] Host to MoCA MMP outbox registes , register set index 6. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_7      0x213ffd34 /* [RW] Host to MoCA MMP outbox registes , register set index 7. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_8      0x213ffd38 /* [RW] Host to MoCA MMP outbox registes , register set index 8. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_9      0x213ffd3c /* [RW] Host to MoCA MMP outbox registes , register set index 9. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_10     0x213ffd40 /* [RW] Host to MoCA MMP outbox registes , register set index 10. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_11     0x213ffd44 /* [RW] Host to MoCA MMP outbox registes , register set index 11. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_12     0x213ffd48 /* [RW] Host to MoCA MMP outbox registes , register set index 12. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_13     0x213ffd4c /* [RW] Host to MoCA MMP outbox registes , register set index 13. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_14     0x213ffd50 /* [RW] Host to MoCA MMP outbox registes , register set index 14. */
#define BCHP_MOCA_HOSTMISC_H2M_MMP_OUTBOX_15     0x213ffd54 /* [RW] Host to MoCA MMP outbox registes , register set index 15. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_0       0x213ffd58 /* [RO] MoCA to Host MMP inbox registers , register set index 0. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_1       0x213ffd5c /* [RO] MoCA to Host MMP inbox registers , register set index 1. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_2       0x213ffd60 /* [RO] MoCA to Host MMP inbox registers , register set index 2. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_3       0x213ffd64 /* [RO] MoCA to Host MMP inbox registers , register set index 3. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_4       0x213ffd68 /* [RO] MoCA to Host MMP inbox registers , register set index 4. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_5       0x213ffd6c /* [RO] MoCA to Host MMP inbox registers , register set index 5. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_6       0x213ffd70 /* [RO] MoCA to Host MMP inbox registers , register set index 6. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_7       0x213ffd74 /* [RO] MoCA to Host MMP inbox registers , register set index 7. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_8       0x213ffd78 /* [RO] MoCA to Host MMP inbox registers , register set index 8. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_9       0x213ffd7c /* [RO] MoCA to Host MMP inbox registers , register set index 9. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_10      0x213ffd80 /* [RO] MoCA to Host MMP inbox registers , register set index 10. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_11      0x213ffd84 /* [RO] MoCA to Host MMP inbox registers , register set index 11. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_12      0x213ffd88 /* [RO] MoCA to Host MMP inbox registers , register set index 12. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_13      0x213ffd8c /* [RO] MoCA to Host MMP inbox registers , register set index 13. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_14      0x213ffd90 /* [RO] MoCA to Host MMP inbox registers , register set index 14. */
#define BCHP_MOCA_HOSTMISC_M2H_MMP_INBOX_15      0x213ffd94 /* [RO] MoCA to Host MMP inbox registers , register set index 15. */
#define BCHP_MOCA_HOSTMISC_DMPG_CHAINS_STATUS    0x213ffd98 /* [RO] "MoCA dynamic memory power gating chain power up (bit per chain),Active when moca_dmpg_gisb_en is high,0: Chain is on,1: Chain is off" */
#define BCHP_MOCA_HOSTMISC_DMPG_CHAINS_PWR_UP    0x213ffd9c /* [RW] "MoCA dynamic memory power gating chain status (bit per chain),0:  Power down chain,1:  Power up chain" */
